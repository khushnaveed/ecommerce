...
const Footer = () => {
  const handleFormSubmit = (e) => {
    ...
    console.log("Email Submitted:", email); // Optional: Handle the email input
        ...
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <ul className="flex items-center space-x-3 mt-9">
              <li>
                <a
                  ...
                  title="Twitter"
                  className="flex items-center justify-center text-gray-200 transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600"
                >
                  <svg
                    className="w-4 h-4"
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    fill="currentColor"
                  >
                    <path d="M23.498 6.186a2.834 2.834 0 0 0-1.993-2.003C19.517 3.428 12 3.428 12 3.428s-7.517 0-9.505.755A2.834 2.834 0 0 0 .502 6.186C0 8.18 0 12 0 12s0 3.819.502 5.813c.264.877.964 1.565 1.993 1.803 1.988.755 9.505.755 9.505.755s7.517 0 9.505-.755a2.834 2.834 0 0 0 1.993-2.003C24 15.819 24 12 24 12s0-3.819-.502-5.813zM9.602 15.27V8.73L15.763 12 9.602 15.27z" />
                  </svg>
                </a>
              </li>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form onSubmit={handleFormSubmit} className="mt-6">
              ...
              <button
                type="submit"
                className="w-5/12 py-3 px-4 mt-4 hover:border font-medium text-gray-200 transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700"
              >
                Send Message
              </button>
            </form>
